#' This file contains a bug fix for rvest::html_table that handles ill-formed rowspan entries in
#' HTML tables.  This is an acknowledged bug---see issue and suggested
#' [fix](https://github.com/tidyverse/rvest/issues/204)---but it not been implemented in `rvest` as
#' at time ACTC 2019 data was scraped (18 July 2019). Hence, this version is included here, and
#' loaded and called in `build-actc-2019.R`.
