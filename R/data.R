#' @title Australian Customs Tariff Classification (ACTC) 2017
...
#' @source The ACTC is published and maintained by the Australian Government Department of Immigration and Border Protection. This data set based on data scraped on 5 October 2017.
...
#' @title Australian Customs Tariff Classification (ACTC) 2019
#' @description  A data set containing the Australian Customs Tariff Classification (ACTC).
#' @format Data set \code{actc_2019} contains the following variables:
#' \describe{
#'   \item{section_number}{ACTC Schedule 3 section number}
#'   \item{section_name}{ACTC Schedule 3 section name}
#'   \item{chapter_number}{ACTC Schedule 3 chapter number}
...
#'   Sections, Chapters, headings, five and six digit subheadings and Notes to Sections and
#'   Chapters are contained in Schedule 3 of the
#'   \href{https://www.abf.gov.au/importing-exporting-and-manufacturing/tariff-classification/current-tariff/schedule-3}{Combined Australian Customs Tariff Nomenclature and Statistical Classification}.
#'  
#'   This dataset is based on the online version of Schedule 3 available on the Australian Border Force website: \href{https://www.abf.gov.au/importing-exporting-and-manufacturing/tariff-classification/current-tariff}{Current Tariff Classification}.
#'
#' @source The ACTC is published and maintained by the Australian Border Force, Australian Government Department of Home Affairs. This data set based on data scraped on 19 July 2019.
#' @references Australian Border Force 2019, \emph{Australian Harmonized Export Commodity Classification (ACTC), Schedule 3 - Current Tariff Classification}, ABF, Canberra. URL: \url{https://www.abf.gov.au/importing-exporting-and-manufacturing/tariff-classification/current-tariff/schedule-3}.
"actc_2019"
